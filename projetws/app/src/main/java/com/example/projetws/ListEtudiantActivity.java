...
public class ListEtudiantActivity extends AppCompatActivity {
    ...
    private static final String URL_LIST = "http://192.168.100.73/projet/ws/loadEtudiant.php";
    private static final String URL_DELETE = "http://192.168.100.73/projet/ws/deleteEtudiant.php";
    private static final String URL_UPDATE = "http://192.168.100.73/projet/ws/updateEtudiant.php";
    ...
    private void showEditDialog(final Etudiant etudiant) {
        ...
        View dialogView = inflater.inflate(R.layout.activity_edit_etudiant, null);
        ...
        if (etudiant.getPhoto() != null && !etudiant.getPhoto().isEmpty()) {
            String imageUrl = "http://192.168.100.73/projet/uploads/" + etudiant.getPhoto();
            Picasso.get()
                    .load(imageUrl)
