...
public class EtudiantAdapter extends RecyclerView.Adapter<EtudiantAdapter.EtudiantViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EtudiantViewHolder holder, int position) {
        ...
        holder.dateNaissance.setText(String.format("Né(e) le: %s",
                formatDate(etudiant.getDateNaissance())));

        // Log pour vérifier les données reçues
        Log.d("ADAPTER_DEBUG", "Etudiant: " + etudiant.getNom() +
    ...
    private String formatDate(String dbDate) {
        if (dbDate == null || dbDate.equals("0000-00-00")) {
            return "Non définie";
        }
        ...
        try {
            ...
            return dbDate; // Retourne la date originale si le parsing échoue
        }
    }
    @Override
